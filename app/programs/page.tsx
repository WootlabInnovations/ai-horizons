        ...
        <main className="flex min-h-screen flex-col">
            ...
            <section className="relative py-20 md:py-28 overflow-hidden bg-gradient-to-b from-background to-muted/30">
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-6">Our 8-Week Elevate Program</h1>
            ...
            <section className="py-12 md:py-16 bg-muted/30" ref={containerRef}>
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">A week-by-week breakdown of your learning journey with Elevate.</p>
                    </motion.div>
